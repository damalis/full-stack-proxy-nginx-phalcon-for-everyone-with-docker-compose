...
<p align="left">
<a href="https://phalcon.io" target="_blank" rel="noreferrer"> <img src="https://avatars.githubusercontent.com/u/1221505?s=200&v=4" alt="Phalcon" height="40" width="40"/> </a>&nbsp;&nbsp;&nbsp; 
...
The containers are now built and running. You should be able to access the Phalcon installation with the configured IP in the browser address. `https://DOMAIN_NAME`.
...
manage docker with [Portainer](https://portainer.io/) is the definitive container management tool for Docker, Docker Swarm with it's highly intuitive GUI and API. 
